...
abstract class Fields extends DecafIntf {
	public abstract void accept(Visitor v);
...
abstract class FieldIntf extends Fields {
	public abstract void accept(Visitor v);
...
class Field1 extends FieldIntf {
	Identifier id = null;
	int val = -1;
...
class Statement1 extends StatementIntf {
	...
	public Statement1(Location loc, ExpressionIntf expr, char op) {
		super();
		this.loc = loc;
		this.expr = expr;
		this.op = op;
...
class ForStatement extends StatementIntf {
	...
	public ForStatement(For s, Identifier id, char ch, ExpressionIntf expr1,
...
class MethodStatementCallOut1 extends StatementIntf {
	...
	ArrayList<callout_arg> calloutargs = null;

	public MethodStatementCallOut1(CallOut s, StringLiteral s1,
			ArrayList<callout_arg> calloutargs) {
		super();
		this.s = s;
		this.s1 = s1;
...
class Expression1 extends ExpressionIntf {
	...
	public Expression1(ExpressionIntf expr, ExpressionIntf term1, char operator) {
		super();
		this.expr = expr;
		this.term1 = term1;
...
class Expression2 extends ExpressionIntf {
	...
	public Expression2(ExpressionIntf term5, char operator) {
		super();
		this.term5 = term5;
		this.operator = operator;
	}
