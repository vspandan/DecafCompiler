...
declarations : type  fields ';' declarations 
						{ 	ArrayList<DeclarationsIntf> decls= new ArrayList<DeclarationsIntf>();
							...
							decls.addAll((ArrayList<DeclarationsIntf>)$4.obj); 
...
fields  : field 
						{  	ArrayList<Fields> field = new ArrayList<Fields>();
							field.add((Fields)$1.obj);
							$$.obj = field; 
						}
	| field ',' fields 
						{  	ArrayList<Fields> field1 = (ArrayList<Fields>)$3.obj;
							field1.add((Fields)$1.obj); 
							$$.obj=field1;
						}
	;
...
field : ID  			{	$$.obj = new Field(new Identifier($1.sval));	}
      | ID  '[' INT_LITERAL  ']' 
      					{	$$.obj = new Field1(new Identifier($1.sval), $3.ival); } 
      ;
...
method_decl  : type ID  '(' args_decl ')' block method_decl 
						{	ArrayList<DeclarationsIntf> methodDecls1=new ArrayList<DeclarationsIntf>();
							...
							methodDecls1.addAll((ArrayList<DeclarationsIntf>)$7.obj); 
							$$.obj = methodDecls1;
						}
	     | VOID ID  '(' args_decl ')' block method_decl 
	     				{	ArrayList<DeclarationsIntf> methodDecls2=new ArrayList<DeclarationsIntf>();
	     					...
	     					methodDecls2.addAll((ArrayList<DeclarationsIntf>)$7.obj);
	     					$$.obj =methodDecls2;
	     				}
...
statements : statement 	{	ArrayList<StatementIntf> statement1 = new ArrayList<StatementIntf>();
	   ...
	   | statement statements 
	   					{	ArrayList<StatementIntf> statement2 = new ArrayList<StatementIntf>();
	   						...
	   						statement2.addAll((ArrayList<StatementIntf>)$2.obj); 
	   						$$.obj = statement2;
	   					};
...
statement: location ASSGN_OP expr ';' 
						{ 	$$.obj = new Statement1((Location)$1.obj,(ExpressionIntf)$3.obj, $2.sval);	} 
	 	 | method_call ';' 
	 	 				{	$$=$1;	}
         ...
         | FOR ID  E_ASSIGN_OP expr ',' expr  block 
         				{	$$.obj = new ForStatement(new For($1.sval),new Identifier($2.sval),$3.sval,(ExpressionIntf)$4.obj,(ExpressionIntf)$6.obj,(Block)$7.obj); 	}
...
callout_args : callout_arg 
						{	ArrayList<ExpressionIntf> calloutargs1 =  new ArrayList<ExpressionIntf>();
							calloutargs1.add((ExpressionIntf)$1.obj); 
							$$.obj = calloutargs1;
						} 
             | callout_arg ',' callout_args ;
             			{	ArrayList<ExpressionIntf> calloutargs2 =  new ArrayList<ExpressionIntf>();
             				calloutargs2.add((ExpressionIntf)$1.obj);
             				calloutargs2.addAll((ArrayList<ExpressionIntf>)($3.obj));
...
method_call  : method_name '('   ')' 
     ...
     | CALLOUT '(' STRING_LITERAL ',' callout_args ')'  
     					{	$$.obj = new MethodStatementCallOut1 (new CallOut($1.sval), new StringLiteral($3.sval),(ArrayList<ExpressionIntf>) $5.obj);	}
...
location : ID			{	$$.obj = new Location1(new Identifier($1.sval)); 	} 
         | ID  '[' expr  ']' 
         				{	$$.obj = new Location2(new Identifier($1.sval), (ExpressionIntf) $3.obj); 	} 
         ;
...
expr  : expr ARTH_OP term1 
						{	$$.obj = new Expression1((ExpressionIntf)$1.obj,(ExpressionIntf)$3.obj, $2.sval);	}
      | term1 			{	$$=$1;	} 
      ;
...
term4 : location    	{	$$=$1; 	}
      | method_call 	{ 	$$=$1; 	}
      | literal     	{	$$=$1;	}
      | MINUS term4 	{	$$.obj = new Expression2((ExpressionIntf)$2.obj, $1.sval);	}
      | '!' term4 		{	$$.obj = new Expression2((ExpressionIntf)$2.obj, $1.sval);	}
